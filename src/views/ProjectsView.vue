...
.project-cover video{width:100%;height:100%;display:block;object-fit:cover}.cover-empty{background:linear-gradient(135deg,#dbeaff,#f7faff)}.activity-list p{cursor:pointer}.activity-list p>b{max-width:260px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.activity-list p>span:not(.activity-icon){color:#6f82a3;font-size:12px}.bottom-empty{height:120px;display:grid;place-items:center;color:var(--muted);font-size:13px}.panel-head>span{color:var(--muted);font-size:12px}
.empty-cover-state{position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;color:#7190bc}.empty-cover-state span{font-size:12px;font-weight:700}.create-intents{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin:0 0 16px}.create-intents>button{height:62px;padding:0 11px;border:1px solid #d5e1f0;border-radius:10px;background:#f8faff;display:flex;align-items:center;gap:9px;text-align:left;color:#526b91}.create-intents>button.active{border-color:#5d9ffc;background:#edf5ff;color:#0869ef;box-shadow:inset 0 0 0 1px #9fc5fb}.create-intents span{display:flex;min-width:0;flex-direction:column;gap:3px}.create-intents b{font-size:13px;white-space:nowrap}.create-intents small{font-size:10px;color:#7a8eac;white-space:nowrap}
.workspace-promise{height:50px;padding:0 15px;border:1px solid var(--line);border-radius:10px;background:rgba(255,255,255,.88);display:flex;align-items:center;gap:10px;color:var(--blue)}.workspace-promise div{display:flex;flex-direction:column;gap:2px}.workspace-promise strong{font-size:13px;color:#17325f}.workspace-promise span{font-size:11px;color:var(--muted)}.project-toolbar{grid-template-columns:minmax(320px,1.2fr) minmax(480px,1.45fr) auto}.continue-label{display:flex;align-items:center;gap:5px;color:var(--blue);font-weight:700}.start-workspace{flex:1;min-height:0;display:flex;flex-direction:column;align-items:center;justify-content:center;padding-bottom:52px}.start-copy{text-align:center;max-width:720px}.start-kicker{display:inline-flex;align-items:center;gap:6px;padding:6px 10px;border-radius:99px;background:#eaf3ff;color:#0869ef;font-size:12px;font-weight:700}.start-copy h2{margin-top:13px;font-size:31px;letter-spacing:-.4px;color:#07183d}.start-copy p{margin-top:9px;color:#64789b;font-size:14px;line-height:1.7}.start-options{width:min(820px,78%);display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-top:28px}.start-card{position:relative;min-height:238px;padding:25px;text-align:left;border:1px solid #d6e2f2;border-radius:16px;background:rgba(255,255,255,.92);box-shadow:0 12px 30px rgba(39,83,143,.09);display:flex;flex-direction:column;align-items:flex-start;transition:.18s ease}.start-card:hover{transform:translateY(-2px);border-color:#8bb8f7;box-shadow:0 15px 34px rgba(26,94,188,.14)}.start-card.recommended{border:2px solid #5d9ffc;background:linear-gradient(145deg,#fff,#f5f9ff)}.start-card>i{position:absolute;top:16px;right:16px;padding:4px 8px;border-radius:99px;background:#e9f3ff;color:#0869ef;font-size:11px;font-style:normal;font-weight:700}.start-icon{width:58px;height:58px;border-radius:14px;display:grid;place-items:center;color:#0869ef;background:#eaf3ff}.start-icon.purple{color:#7651d9;background:#f0ebff}.start-card>strong{margin-top:16px;font-size:20px;color:#10284f}.start-card>p{margin-top:7px;color:#65799d;font-size:13px;line-height:1.65}.start-card>b{margin-top:auto;display:flex;align-items:center;gap:7px;color:#0869ef;font-size:14px}.blank-project{margin-top:16px;border:0;background:transparent;color:#557097;display:flex;align-items:center;gap:6px}.blank-project:hover{color:var(--blue)}.start-footnotes{display:flex;gap:28px;margin-top:31px;color:#607594;font-size:12px}.start-footnotes span{display:flex;align-items:center;gap:7px}.project-dialog{width:520px;padding:24px}.project-dialog header p{max-width:405px;line-height:1.55}.optional-label{margin-top:18px;padding-top:14px;border-top:1px solid #e5ebf4;color:#7083a3;font-size:11px}.optional-fields{display:grid;grid-template-columns:1fr 1fr;gap:12px}.optional-fields label{margin-top:10px}@media(max-width:1380px){.project-toolbar{grid-template-columns:280px 1fr auto}.start-options{width:86%}.start-workspace{padding-bottom:16px}}
</style>
