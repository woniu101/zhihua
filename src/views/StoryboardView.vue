...
.reference-inputs{margin:-3px 0 12px;padding:9px 10px;border:1px solid #d9e4f1;border-radius:8px;background:#f8fbff;display:grid;grid-template-columns:1fr 1fr;gap:7px}.reference-inputs .field-head{grid-column:1/-1;margin:0 0 2px}.reference-inputs .field-head a{color:var(--blue);font-size:14px}.reference-inputs label{display:flex;flex-direction:column;gap:4px;color:#52698c;font-size:13px}.reference-inputs select{height:34px;min-width:0;border:1px solid #cfdced;border-radius:6px;background:#fff;padding:0 8px;color:#203b65}.reference-inputs p{grid-column:1/-1;color:#7385a2;font-size:13px}
.narration-import-row{display:grid;grid-template-columns:1fr auto auto;gap:7px;align-items:center;margin-top:7px}.narration-import-row .select{height:34px}.narration-import-row a{color:var(--blue);font-size:13px;white-space:nowrap}
.narration-modes{display:grid;grid-template-columns:repeat(3,1fr);margin-bottom:8px}.narration-off-note{padding:14px;border:1px solid var(--line);border-radius:8px;background:var(--surface-soft);color:var(--muted);font-size:14px;line-height:1.6}.ambient-field{margin-bottom:8px}.ambient-field textarea{height:58px}.audio-policy-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:6px}.audio-policy-grid button{min-height:68px;padding:8px;border:1px solid var(--line);border-radius:8px;background:var(--surface);text-align:left;color:var(--text)}.audio-policy-grid b,.audio-policy-grid span{display:block}.audio-policy-grid span{margin-top:4px;color:var(--muted);font-size:13px;line-height:1.35}.audio-policy-grid button.active{border-color:var(--blue);background:#edf5ff;color:var(--blue)}
.locked-note{margin-bottom:10px;padding:9px 11px;border:1px solid #efc36a;border-radius:7px;display:flex;align-items:center;gap:7px;background:#fff8e8;color:#8b5a08;font-size:14px}.scene-locked>:not(.locked-note){opacity:.58;pointer-events:none}.shot-actions button:disabled{opacity:.35;cursor:not-allowed}.prompt-mode{display:flex;gap:3px;padding:2px;border-radius:7px;background:#eef3f9}.prompt-mode button{height:28px;border:0;border-radius:5px;padding:0 9px;background:transparent;color:var(--muted);font-size:13px}.prompt-mode button.active{background:#fff;color:var(--blue);box-shadow:0 1px 4px #cbd8e9}.intent-editor{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:14px}.intent-editor label{display:flex;flex-direction:column;gap:5px;color:var(--text);font-size:13px;font-weight:700}.intent-editor input,.intent-editor textarea{min-width:0;border:1px solid var(--line);border-radius:7px;background:var(--surface);padding:8px;color:var(--text)}.intent-editor input{height:36px}.intent-editor textarea{height:64px;resize:vertical}.intent-editor .wide{grid-column:1/-1}.prompt-preview{padding:9px 10px;border:1px solid #cfe0f7;border-radius:8px;background:#f6faff;font-size:13px}.prompt-preview p{margin:5px 0;color:#405a80;line-height:1.5}.prompt-preview span{color:#b36a15}.prompt-preview .success-text{color:#13835a}.audio-intents{display:grid;grid-template-columns:repeat(3,1fr);margin-bottom:9px}
...
.pool-pill{height:49px;padding:0 10px;border:1px solid var(--line);border-radius:9px;background:var(--surface);display:flex;align-items:center;gap:7px;color:var(--muted);font-size:13px;white-space:nowrap}.pool-pill select{height:30px;border:1px solid #cbd9eb;border-radius:6px;background:var(--surface-soft);padding:0 7px;color:var(--text);font-size:14px;font-weight:700}.pool-pill.active{border-color:#9fc3f4;background:#f2f7ff;color:var(--blue)}
