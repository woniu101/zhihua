...
<style scoped>
.projects-page{display:flex;flex-direction:column;gap:10px}.page-head{min-height:70px}.compute{padding-top:4px}.local-projects{height:54px;min-width:310px;border:1px solid var(--line);border-radius:9px;background:#fff;display:flex;align-items:center;gap:12px;padding:0 17px;box-shadow:var(--shadow);color:var(--blue)}.local-projects div{display:flex;flex-direction:column;color:#203962}.local-projects span{font-size:14px;color:var(--muted);margin-top:2px}.project-toolbar{display:grid;grid-template-columns:minmax(320px,1.2fr) minmax(480px,1.45fr) auto auto;gap:12px;align-items:center}.filters{padding:5px;background:#fff;border:1px solid var(--line);border-radius:10px}.filters .tab-btn{border:0;min-width:72px}.project-grid{flex:1;min-height:0;display:grid;grid-template-columns:repeat(4,minmax(220px,1fr));grid-template-rows:repeat(2,minmax(0,1fr));gap:14px}.project-card{position:relative;min-height:0;display:grid;grid-template-rows:minmax(100px,1fr) auto 38px;background:#fff;border:1px solid var(--line);border-radius:10px;overflow:visible;box-shadow:var(--shadow);cursor:pointer}.project-card:focus-visible{outline:3px solid #9dc4ff}.project-card.selected{border:2px solid var(--blue);box-shadow:0 7px 20px rgba(15,111,255,.14)}.project-cover{position:relative;min-height:0;background-position:center;background-size:cover;border-radius:9px 9px 0 0}.project-cover .badge{position:absolute;top:10px;right:43px}.cover-menu{position:absolute;top:8px;right:8px;width:30px;height:34px;border:0;border-radius:8px;color:#fff;background:rgba(6,26,53,.62);display:grid;place-items:center}.project-menu{position:absolute;z-index:15;top:45px;right:8px;width:142px;padding:5px;border:1px solid #d4dfed;border-radius:8px;background:#fff;box-shadow:0 12px 28px rgba(16,43,84,.2)}.project-menu button{width:100%;height:34px;padding:0 10px;border:0;border-radius:6px;background:transparent;display:flex;align-items:center;gap:8px;color:#263e68}.project-menu button:hover{background:#edf4ff}.project-menu .danger-text{color:#dc3d46}.recent{position:absolute;z-index:2;top:8px;left:8px;border-radius:6px;padding:6px 10px;color:#fff;background:var(--blue);font-size:14px;font-weight:700}.project-info{padding:10px 14px 8px;overflow:hidden}.project-info h3{font-size:18px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.project-info p{margin-top:5px;color:#62779c;font-size:14px}.project-meta{display:flex;gap:22px;margin-top:10px;color:#263f6a;font-size:14px}.project-meta span{display:flex;align-items:center;gap:6px}.project-card>footer{border-top:1px solid #edf1f7;padding:0 14px;display:flex;align-items:center;justify-content:space-between;font-size:14px;color:#7386a7}.autosave{display:flex;align-items:center;gap:6px}.autosave i{width:18px;height:18px;border-radius:50%;display:grid;place-items:center;background:var(--blue);color:#fff;font-style:normal}.empty-projects{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;color:#6b80a3}.empty-projects strong{font-size:19px;color:#29436e}.project-bottom{height:182px;display:grid;grid-template-columns:1.1fr 1fr;gap:14px}.activity-list{padding:5px 22px}.activity-list p{height:38px;display:flex;align-items:center;gap:12px;color:#263f6a;font-size:14px}.activity-list time{margin-left:auto;color:#6f82a3}.activity-icon{font-weight:800}.activity-icon.blue{color:var(--blue)}.activity-icon.purple{color:#8057e8}.storage-body{height:124px;display:flex;gap:18px;align-items:center;padding:12px 26px}.drive{width:62px;height:60px;display:grid;place-items:center;border-radius:10px;background:#edf5ff;color:var(--blue);font-size:38px}.storage-body>div{flex:1}.storage-body>div>div:first-child{display:flex;justify-content:space-between;margin-bottom:13px;color:#2b426b}.storage-body p{display:flex;gap:26px;margin-top:13px;color:#64789a;font-size:14px}.storage-body p span:nth-child(1){color:#2773e9}.storage-body p span:nth-child(2){color:#10a670}.modal-backdrop{position:fixed;z-index:100;inset:0;background:rgba(8,25,55,.38);display:grid;place-items:center}.project-dialog{width:470px;padding:22px;border:1px solid #d6e1ef;border-radius:14px;background:#fff;box-shadow:0 22px 60px rgba(14,40,78,.25)}.project-dialog header{display:flex;justify-content:space-between;margin-bottom:20px}.project-dialog header p{margin-top:7px;color:#7184a4;font-size:14px}.project-dialog header button{width:34px;height:34px;border:0;border-radius:7px;background:#eef3f9;display:grid;place-items:center}.project-dialog label{display:flex;flex-direction:column;gap:7px;margin-top:14px;font-size:14px;font-weight:700}.project-dialog input,.project-dialog select{height:44px;padding:0 12px;border:1px solid #cddbef;border-radius:8px;outline:none;background:#fff}.project-dialog input:focus,.project-dialog select:focus{border-color:var(--blue);box-shadow:0 0 0 3px #e5f0ff}.project-dialog>footer{display:flex;justify-content:flex-end;gap:10px;margin-top:22px}.form-error{margin-top:8px;color:#df3f48;font-size:14px}@media(max-width:1380px){.project-toolbar{grid-template-columns:280px 1fr auto auto}.filters .tab-btn{min-width:60px;padding:0 10px}.project-grid{gap:10px}.project-bottom{height:165px}.project-meta{gap:12px}.project-card>footer{padding:0 9px}}
.project-cover video{width:100%;height:100%;display:block;object-fit:cover}.cover-empty{background:linear-gradient(135deg,#dbeaff,#f7faff)}.activity-list p{cursor:pointer}.activity-list p>b{max-width:260px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.activity-list p>span:not(.activity-icon){color:#6f82a3;font-size:14px}.bottom-empty{height:120px;display:grid;place-items:center;color:var(--muted);font-size:14px}.panel-head>span{color:var(--muted);font-size:14px}
.empty-cover-state{position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;color:#7190bc}.empty-cover-state span{font-size:14px;font-weight:700}.create-intents{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin:0 0 16px}.create-intents>button{height:62px;padding:0 11px;border:1px solid #d5e1f0;border-radius:10px;background:#f8faff;display:flex;align-items:center;gap:9px;text-align:left;color:#526b91}.create-intents>button.active{border-color:#5d9ffc;background:#edf5ff;color:#0869ef;box-shadow:inset 0 0 0 1px #9fc5fb}.create-intents span{display:flex;min-width:0;flex-direction:column;gap:3px}.create-intents b{font-size:14px;white-space:nowrap}.create-intents small{font-size:14px;color:#7a8eac;white-space:nowrap}
.workspace-promise{height:50px;padding:0 15px;border:1px solid var(--line);border-radius:10px;background:rgba(255,255,255,.88);display:flex;align-items:center;gap:10px;color:var(--blue)}.workspace-promise div{display:flex;flex-direction:column;gap:2px}.workspace-promise strong{font-size:14px;color:#17325f}.workspace-promise span{font-size:14px;color:var(--muted)}.project-toolbar{grid-template-columns:minmax(320px,1.2fr) minmax(480px,1.45fr) auto}.continue-label{display:flex;align-items:center;gap:5px;color:var(--blue);font-weight:700}.start-workspace{flex:1;min-height:0;display:flex;flex-direction:column;align-items:center;justify-content:center;padding-bottom:52px}.start-copy{text-align:center;max-width:720px}.start-kicker{display:inline-flex;align-items:center;gap:6px;padding:6px 10px;border-radius:99px;background:#eaf3ff;color:#0869ef;font-size:14px;font-weight:700}.start-copy h2{margin-top:13px;font-size:31px;letter-spacing:-.4px;color:#07183d}.start-copy p{margin-top:9px;color:#64789b;font-size:14px;line-height:1.7}.start-options{width:min(820px,78%);display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-top:28px}.start-card{position:relative;min-height:238px;padding:25px;text-align:left;border:1px solid #d6e2f2;border-radius:16px;background:rgba(255,255,255,.92);box-shadow:0 12px 30px rgba(39,83,143,.09);display:flex;flex-direction:column;align-items:flex-start;transition:.18s ease}.start-card:hover{transform:translateY(-2px);border-color:#8bb8f7;box-shadow:0 15px 34px rgba(26,94,188,.14)}.start-card.recommended{border:2px solid #5d9ffc;background:linear-gradient(145deg,#fff,#f5f9ff)}.start-card>i{position:absolute;top:16px;right:16px;padding:4px 8px;border-radius:99px;background:#e9f3ff;color:#0869ef;font-size:14px;font-style:normal;font-weight:700}.start-icon{width:58px;height:58px;border-radius:14px;display:grid;place-items:center;color:#0869ef;background:#eaf3ff}.start-icon.purple{color:#7651d9;background:#f0ebff}.start-card>strong{margin-top:16px;font-size:20px;color:#10284f}.start-card>p{margin-top:7px;color:#65799d;font-size:14px;line-height:1.65}.start-card>b{margin-top:auto;display:flex;align-items:center;gap:7px;color:#0869ef;font-size:14px}.blank-project{margin-top:16px;border:0;background:transparent;color:#557097;display:flex;align-items:center;gap:6px}.blank-project:hover{color:var(--blue)}.start-footnotes{display:flex;gap:28px;margin-top:31px;color:#607594;font-size:14px}.start-footnotes span{display:flex;align-items:center;gap:7px}.project-dialog{width:520px;padding:24px}.project-dialog header p{max-width:405px;line-height:1.55}.optional-label{margin-top:18px;padding-top:14px;border-top:1px solid #e5ebf4;color:#7083a3;font-size:14px}.optional-fields{display:grid;grid-template-columns:1fr 1fr;gap:12px}.optional-fields label{margin-top:10px}@media(max-width:1380px){.project-toolbar{grid-template-columns:280px 1fr auto}.start-options{width:86%}.start-workspace{padding-bottom:16px}}

/* Projects use semantic colors so summary text remains legible in both themes. */
.local-projects,.filters,.project-card,.project-menu,.project-dialog{color:var(--text);border-color:var(--line);background:var(--surface)}
.local-projects div,.project-info h3,.project-menu button,.project-dialog h2,.project-dialog label,.activity-list p>b,.storage-body>div>div:first-child,.storage-body strong{color:var(--text)}
.local-projects span,.project-info p,.project-meta,.project-card>footer,.empty-projects,.activity-list time,.activity-list p>span:not(.activity-icon),.storage-body p,.empty-cover-state,.project-dialog header p,.optional-label{color:var(--muted)}
.project-card>footer,.optional-label{border-color:var(--line)}
.project-menu button:hover{background:var(--control-hover)}
.drive{color:var(--blue);background:var(--blue-soft)}
.storage-body strong{font-size:16px}.activity-list p>b{font-size:15px}
.storage-body p span:nth-child(1){color:var(--blue)}.storage-body p span:nth-child(2){color:var(--green)}
.project-dialog header button{color:var(--text);background:var(--surface-muted)}
.project-dialog input,.project-dialog select{color:var(--text);border-color:var(--border-control);background:var(--control)}
:global(:root[data-theme="dark"]) .workspace-promise{background:var(--surface)}
:global(:root[data-theme="dark"]) .workspace-promise strong,:global(:root[data-theme="dark"]) .start-copy h2,:global(:root[data-theme="dark"]) .start-card>strong{color:var(--text)}
:global(:root[data-theme="dark"]) .start-copy p,:global(:root[data-theme="dark"]) .start-card>p,:global(:root[data-theme="dark"]) .start-footnotes,:global(:root[data-theme="dark"]) .blank-project{color:var(--muted)}
:global(:root[data-theme="dark"]) .start-card,:global(:root[data-theme="dark"]) .start-card.recommended{border-color:var(--line);background:var(--surface)}
</style>
