...
“知画”是一款以项目和分镜为中心的 AI 视觉创作桌面工具，面向教师、科普人员、学校宣传人员、公益组织、基层宣传工作者及轻量内容创作者。它既能把资料整理成短视频，也能把每张图片、每段候选视频和独立音轨作为可继续剪辑的素材交付。
...
> 导入资料，逐步审核和调整分镜，生成可交付素材或直接完成轻量成片。
...
“设置与算力”入口位于侧栏底部，用于配置当前大模型提供商、优云智算、ComfyUI、TTS、FFmpeg、本地存储和界面主题，并承担首次环境准备、日常实例管理、轻量费用提示与可选防回收设置。
...
设计原则是“先审核内容，再消耗算力”。当前大模型生成的大纲、旁白和提示词都允许用户在提交视频任务前修改。
